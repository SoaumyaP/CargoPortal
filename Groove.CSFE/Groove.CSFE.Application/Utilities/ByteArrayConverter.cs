// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ByteArrayConverter.cs" company="Groove Technology">
...
namespace Groove.CSFE.Application.Utilities
{
    ...
    public static class ByteArrayConverter
    {
        ...
        /// The hex index.
        /// </summary>
        private static readonly IDictionary<string, byte> HexIndex = CreateHexLookup();
        ...
        private static IDictionary<string, byte> CreateHexLookup()
        {
