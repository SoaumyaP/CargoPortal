...
{
    public class BulkFulfillmentOrderViewModel: IHasViewSetting
    {
        ...
        public string ViewSettingModuleId { get; set; } = Core.Models.ViewSettingModuleId.BULKBOOKING_DETAIL_CARGO_DETAILS;
