...
namespace Groove.SP.Application.MasterBillOfLading.ViewModels
{
    ...
    public class MasterBillOfLadingItineraryViewModel : ViewModelBase<MasterBillOfLadingItineraryModel>, IHasFieldStatus
    {
        ...
        {
            new MasterBillItineraryValidation(isUpdating).ValidateAndThrow(this);
        }
