...
{
    public class UpdateContractMasterViewModel : ContractMasterViewModel, IValidatableObject, IHasFieldStatus
    {
        public IEnumerable<ValidationResult> Validate(System.ComponentModel.DataAnnotations.ValidationContext validationContext)
        {
            var validator = (IValidator<UpdateContractMasterViewModel>)validationContext.GetService(typeof(IValidator<UpdateContractMasterViewModel>));
