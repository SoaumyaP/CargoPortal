...
{
    public class POFulfillmentLoadViewModel : IHasViewSetting
    {
        ...
        public string ViewSettingModuleId { get; set; } = Core.Models.ViewSettingModuleId.FREIGHTBOOKING_DETAIL_LOADS;
