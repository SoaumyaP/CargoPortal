...
describe('BalanceOfGoodsEnquiryComponent 2', () => {
  ...
  beforeEach(async(() => {
    ...
    const query = bs.query.and.returnValue(of({totalRecords: 1, records: [{prinicpleId: 1, availableQuantity: 100}]}));
  ...
  it('affiliates has value', () => {
    expect(component.affiliates === '[]').toBeTruthy();
  });

  it('query should contain affiliates', () => {
    component.loadData();
    expect(component.affiliates === '[]');
