...
@Component({
  selector: 'app-po-fulfillment-note-popup',
  templateUrl: './po-fulfillment-note-popup.component.html',
  styleUrls: ['./po-fulfillment-note-popup.component.scss']
})
export class PoFulfillmentNotePopupComponent extends NotePopupComponent implements OnInit, OnChanges {
