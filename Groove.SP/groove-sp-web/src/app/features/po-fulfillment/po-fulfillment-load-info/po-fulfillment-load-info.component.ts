...
@Component({
    selector: 'app-po-fulfillment-load-info',
    templateUrl: './po-fulfillment-load-info.component.html',
    styleUrls: ['./po-fulfillment-load-info.component.scss'],
    viewProviders: [{ provide: ControlContainer, useExisting: NgForm }]
})
export class POFulfillmentLoadInfoComponent implements OnInit, OnDestroy {
