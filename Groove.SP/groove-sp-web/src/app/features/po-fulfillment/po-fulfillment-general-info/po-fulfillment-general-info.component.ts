...
import { OrganizationNameRole, EquipmentType, POType, ModeOfTransportType, ValidationDataType, POFulfillmentStageType, RoleSequence, ViewSettingModuleIdType } from 'src/app/core/models/enums/enums';
...
@Component({
    selector: 'app-po-fulfillment-general-info',
    templateUrl: './po-fulfillment-general-info.component.html',
    styleUrls: ['./po-fulfillment-general-info.component.scss'],
    viewProviders: [{ provide: ControlContainer, useExisting: NgForm }],
})
export class POFulfillmentGeneralInfoComponent implements OnInit, OnChanges, OnDestroy {
    ...
    private bindSupplier() {
        ...
        this._isFulfilledFromPO.subscribe((val) => {
            if (val !== null && !val && this.isAddMode) {
                this.service
                    .getOrganizationsByIds([this.model.currentOrganization.id])
                    .subscribe((data) => {
                        this.model.contacts.push({
                            organizationId: this.model.currentOrganization.id,
