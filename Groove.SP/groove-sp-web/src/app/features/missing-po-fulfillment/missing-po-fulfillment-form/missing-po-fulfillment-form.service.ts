...
import { HttpService, FormService, StringHelper, POType, DropDownListItemModel, EntityType, ModeOfTransportType } from 'src/app/core';
...
@Injectable()
export class MissingPOFulfillmentFormService extends FormService<any> {
    ...
    */
     ...
     * @param bookingId POFulfillmentId
     * @param model 
     * @returns 
     */
    askForMissingPO(bookingId: number, model: any) {
        return this.httpService.create(`${environment.apiUrl}/pofulfillments/${bookingId}/ask-missing-po`, model);
    }
