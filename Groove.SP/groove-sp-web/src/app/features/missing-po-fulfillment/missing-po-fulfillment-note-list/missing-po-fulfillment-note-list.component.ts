...
@Component({
  selector: 'app-missing-po-fulfillment-note-list',
  templateUrl: './missing-po-fulfillment-note-list.component.html',
  styleUrls: ['./missing-po-fulfillment-note-list.component.scss']
})
export class MissingPOFulfillmentNoteListComponent extends NoteListComponent implements OnInit, OnChanges, OnDestroy {
    ...
    constructor(
        ...
        protected _poFulfillmentService: MissingPOFulfillmentFormService,
    ...
    ngOnChanges() {
        ...
        this.poItemOptions = this.poFulfillmentOrders.filter(x => x.purchaseOrderId > 0).map(i => new POLineItemModel(i.purchaseOrderId, i.customerPONumber, i.poLineItemId, i.productCode));
    }
