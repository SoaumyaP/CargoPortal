...
@Component({
    selector: 'app-missing-po-fulfillment-activity',
    templateUrl: './missing-po-fulfillment-activity.component.html',
    styleUrls: ['./missing-po-fulfillment-activity.component.scss']
})
export class MissingPOFulfillmentActivityComponent implements OnInit {
    ...
    constructor(
        private fulfillmentService: MissingPOFulfillmentFormService,
    ...
    /**
     * Call to map activity with the corresponding booking milestone.
     */
    mappingMilestone() {
    ...
    /**
     * To get the list of activities by POFF Id then do other steps (grouping/mapping milestone/sorting...) to build the model for time line. 
     * */
    async getActivities() {
    ...
    /**
     * Filter activity (on the client side) by inputted criteria value.
     * @returns 
     */
