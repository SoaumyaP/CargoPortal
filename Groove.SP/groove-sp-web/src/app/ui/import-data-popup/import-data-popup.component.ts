...
import { FileRestrictions, FileState, SelectEvent, SuccessEvent, UploadEvent } from '@progress/kendo-angular-upload';
...
export class ImportDataPopupComponent implements OnInit, OnChanges {
    ...
    currentImportStep: ImportDataStep;
    widthPopup: number;
    heightPopup: number;
    ...
    ngOnInit() {
        ...
        this._updatePopupStyle(ImportDataStep.Initial);
    }

     get isSelectingFile() {
        return this.currentImportStep === ImportDataStep.Initial;
    }

    get isSelectedFile() {
        return this.currentImportStep === ImportDataStep.FileSelected;
    }

    get isImporting() {
        return this.currentImportStep === ImportDataStep.Importing;
    }

    get isDone() {
        return this.currentImportStep === ImportDataStep.Done;
    }
    ...
    private _updatePopupStyle(step: ImportDataStep, isShowLogs?: boolean) {
        this.currentImportStep = step;
        const dialog: HTMLCollectionOf<Element> = document.getElementsByClassName('import-data-dialog');
    ...
    uploadSuccessHandler(event: SuccessEvent) {
        ...
        this.backgroundJobMonitor.onProgressChanged = (data) => {
            ...
            //     this.progressTitle = `${this.completedProgress} / ${this.overallProgress}`;
            // } else {
            //     this.progressTitle = '';
            // }
            ...
            this.currentImportStep =  ImportDataStep.Importing;
            this.importDataProcessStatus = data.status;
        };
    ...
    selectEventHandler(e: SelectEvent) {
        ...
        this._updatePopupStyle(ImportDataStep.FileSelected);
    }
    ...
    importData(): void {
        ...
        if (uploadButtons.length > 0) {
            ...
            uploadButton.click();
            this._updatePopupStyle(ImportDataStep.Importing);
        }
    }
