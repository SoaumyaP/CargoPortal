/*
* Telerik Reporting R2 2017 (http://www.telerik.com/products/reporting.aspx)
...
*/
.trv-report-viewer .k-menu.k-menu-horizontal:not(.k-context-menu){padding:0}
.trv-menu-small .k-item, .k-widget.k-menu-horizontal>.k-item{float:left}
.trv-menu-large .k-item > .k-link > .k-icon::before{left:initial;right:initial}
.trv-pages-area .trv-error-pane{left:50%;position:relative;float:left;display:none;max-width:80%}
.trv-pages-area>.trv-error-pane>.trv-centered{position:relative;float:left;left:-50%;padding:1em}
...
.trv-pages-area.trv-loading .trv-page-overlay{display:block}
.trv-pages-area.trv-error .trv-error-pane{display:block}
...
.trv-pages-area div{box-sizing:content-box}
...
.trv-parameters-area.trv-loading .trv-parameters-area-overlay{display:block}
...
.trv-parameters-area.trv-error .trv-error-pane{display:block}
...
.trv-parameter-editor-available-values-multiselect .trv-list{overflow:auto}
.trv-parameter-editor-available-values-multiselect .footer{font-size:8pt}
.trv-parameter-editor-available-values-multiselect .trv-select-all{}
...
.trv-menu-large{border-style:none}
...
.trv-document-map.trv-loading .trv-document-map-overlay{display:block}
.trv-document-map.trv-hidden{display:none}
.trv-parameters-area{position:absolute;width:15em;height:auto;top:0;bottom:0;right:0;z-index:10}
.trv-parameters-area.trv-hidden{display:none}
...
.trv-parameters-area.trv-hidden~.trv-pages-area{right:0}
.trv-document-map.trv-hidden~.trv-pages-area
{left:0}}
...
.trv-search-dialog-stopsearch-placeholder {
    float: right;
}

.trv-search-dialog-input-area .k-combobox {
    margin-left: 0;
    width: calc(100% - 30px - 0.2em - 0.2em);
}

.trv-search-dialog-input-area .trv-search-dialog-stopsearch-placeholder {
    margin: 0.7em 0.2em 0.2em 0.2em;
    background: transparent;
    border: none
}

.trv-search-dialog-input-area .trv-search-dialog-stopsearch-placeholder li.k-item,
...
.trv-search-dialog-input-area .trv-search-dialog-stopsearch-placeholder .k-i-close {
    font-size: 23px;
    top: 8px;
    position: relative;
}
...
.trv-search-dialog-search-options.k-widget .k-item.k-state-hover:last-of-type,
.trv-search-dialog-search-options.k-widget .k-item:last-of-type > .k-link {
    background:none;
    color: red;
    cursor: default;
}
...
.trv-search-dialog-search-options .k-item .k-link,
.trv-search-dialog-navigational-buttons .k-item .k-link {
    padding: .2em 0.5em;
}
...
.trv-search-dialog-highlighted-result {
    background-color: rgba(0, 35, 102, 0.3) !important; /*royalblue*/
...
/* DO NOT MODIFY OR DELETE THIS LINE! UPGRADE WIZARD CHECKSUM 99ADB83FE42C7832CC549CD712146A9E */