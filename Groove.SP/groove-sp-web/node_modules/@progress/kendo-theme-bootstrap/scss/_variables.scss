...
$button-calc-size: calc( #{$button-inner-calc-size} + #{$input-border-width * 2} ) !default;
...
$input-inner-calc-size: calc( #{$input-line-height * 1em} + #{$input-padding-y * 2} ) !default;
$input-calc-size: calc( #{$input-inner-calc-size} + #{$input-border-width * 2} ) !default;
...
$picker-select-size: calc( #{$picker-select-padding-x * 2} + #{$icon-size} + #{$picker-select-border-width} ) !default;
...
//Checkboxes
$check-icon-size: $icon-size !default;
...
$grid-sorting-index-spacing-y: 2px !default;
...
$card-body-padding-y: $card-padding-x !default; // In bootstrap, all card body paddings equal the card-spacer-x var

$card-title-margin-bottom: $h5-margin-bottom !default;
$card-subtitle-margin-bottom: $h6-margin-bottom !default;
$card-subtitle-margin-top: $padding-y-lg !default;
$card-subtitle-text: true-mix($card-text, $card-bg, 65%) !default;
...
$calendar-today-color: $accent !default;
...
$switch-label-text-transform: null !default !default;
...
$scheduler-event-selected-box-shadow: inset 0 0 0 3px rgba(255, 255, 255, .5) !default;
...
$scheduler-nonwork-bg: mix( $panel-text, $panel-bg, ($color-level-step / 2) ) !default;

// Adaptive Common
$adaptive-content-bg: $base-bg !default;
$adaptive-content-text: $accent !default;

$adaptive-menu-bg: $accent !default;
$adaptive-menu-text: white !default;

$adaptive-menu-clear-text: $accent !default;

$adaptive-menu-item-border: $grid-border !default;
$adaptive-menu-title-text: $base-text !default;

// Adaptive Grid
$adaptive-grid-sort-text: $accent !default;

// Adaptive Scheduler
$adaptive-scheduler-current-text: $accent !default;
...
$pdf-viewer-canvas-bg: $chat-bg !default;
...
$pdf-viewer-page-text: $panel-text !default;
...
// Drawer
$drawer-text: $text-color !default;
$drawer-bg: $bg-color !default;
$drawer-border: $border-color !default;
...
$spreadsheet-insert-image-dialog-preview-border-bg: $border-color !default;
...
$spreadsheet-insert-image-dialog-overlay-hovered-text: $bg-color !default;
...
$spreadsheet-drawing-handle-outline-color: $accent !default;
$spreadsheet-drawing-handle-border-color: $selected-bg !default;
$spreadsheet-drawing-handle-bg: $accent !default;
...
$filter-field-text: $accent !default;
