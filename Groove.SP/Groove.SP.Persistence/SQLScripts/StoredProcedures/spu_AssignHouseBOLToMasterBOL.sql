...
IF OBJECT_ID('spu_AssignHouseBOLToMasterBOL', 'P') IS NOT NULL
DROP PROC dbo.spu_AssignHouseBOLToMasterBOL
GO

-- =============================================
-- Author:		Cuong Duong Duy
-- Create date: 13 June 2021
-- Description:	To assign master bill of lading to house bill of lading.
-- BillOfLadings (House BL) <-> MasterBills (Master BL)
-- =============================================
CREATE PROCEDURE [dbo].[spu_AssignHouseBOLToMasterBOL]
