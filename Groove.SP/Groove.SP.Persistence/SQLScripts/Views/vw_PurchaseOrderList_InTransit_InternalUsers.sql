...
IF EXISTS(SELECT * FROM sys.views WHERE NAME = 'vw_PurchaseOrderList_InTransit_InternalUsers')
BEGIN
	 DROP VIEW vw_PurchaseOrderList_InTransit_InternalUsers;
END
GO

CREATE VIEW [dbo].[vw_PurchaseOrderList_InTransit_InternalUsers]
AS
