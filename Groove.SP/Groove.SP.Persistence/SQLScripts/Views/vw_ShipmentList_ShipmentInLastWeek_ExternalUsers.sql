...
IF EXISTS(SELECT * FROM sys.views WHERE NAME = 'vw_ShipmentList_ShipmentInLastWeek_ExternalUsers')
BEGIN
	 DROP VIEW vw_ShipmentList_ShipmentInLastWeek_ExternalUsers;
END
GO

CREATE VIEW [dbo].[vw_ShipmentList_ShipmentInLastWeek_ExternalUsers]
AS
