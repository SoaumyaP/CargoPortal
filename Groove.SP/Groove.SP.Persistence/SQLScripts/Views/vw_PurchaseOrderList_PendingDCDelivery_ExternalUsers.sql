...
IF EXISTS(SELECT * FROM sys.views WHERE NAME = 'vw_PurchaseOrderList_PendingDCDelivery_ExternalUsers')
BEGIN
	 DROP VIEW vw_PurchaseOrderList_PendingDCDelivery_ExternalUsers;
END
GO

CREATE VIEW [dbo].[vw_PurchaseOrderList_PendingDCDelivery_ExternalUsers]
AS
