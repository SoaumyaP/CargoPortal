...
IF EXISTS(SELECT * FROM sys.views WHERE NAME = 'vw_ShipmentList_ShipmentInThisWeek_InternalUsers')
BEGIN
	 DROP VIEW vw_ShipmentList_ShipmentInThisWeek_InternalUsers;
END
GO

CREATE VIEW [dbo].[vw_ShipmentList_ShipmentInThisWeek_InternalUsers]
AS
