...
IF EXISTS(SELECT * FROM sys.views WHERE NAME = 'vw_PurchaseOrderList_DCDeliveryConfirmed_ExternalUsers')
BEGIN
	 DROP VIEW vw_PurchaseOrderList_DCDeliveryConfirmed_ExternalUsers;
END
GO

CREATE VIEW [dbo].[vw_PurchaseOrderList_DCDeliveryConfirmed_ExternalUsers]
AS
