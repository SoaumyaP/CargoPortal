...
IF EXISTS(SELECT * FROM sys.views WHERE NAME = 'vw_ShipmentList_MonthlyMovementShipmentVolume_InternalUsers')
BEGIN
	 DROP VIEW vw_ShipmentList_MonthlyMovementShipmentVolume_InternalUsers;
END
GO

CREATE VIEW [dbo].[vw_ShipmentList_MonthlyMovementShipmentVolume_InternalUsers]
AS
