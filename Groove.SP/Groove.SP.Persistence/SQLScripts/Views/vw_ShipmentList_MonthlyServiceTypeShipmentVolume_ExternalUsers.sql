...
IF EXISTS(SELECT * FROM sys.views WHERE NAME = 'vw_ShipmentList_MonthlyServiceTypeShipmentVolume_ExternalUsers')
BEGIN
	 DROP VIEW vw_ShipmentList_MonthlyServiceTypeShipmentVolume_ExternalUsers;
END
GO

CREATE VIEW [dbo].[vw_ShipmentList_MonthlyServiceTypeShipmentVolume_ExternalUsers]
AS
