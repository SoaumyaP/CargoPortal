...
IF EXISTS(SELECT * FROM sys.views WHERE NAME = 'vw_PurchaseOrderList_POIssuedInLastWeek_ExternalUsers')
BEGIN
	 DROP VIEW vw_PurchaseOrderList_POIssuedInLastWeek_ExternalUsers;
END
GO

CREATE VIEW [dbo].[vw_PurchaseOrderList_POIssuedInLastWeek_ExternalUsers]
AS
