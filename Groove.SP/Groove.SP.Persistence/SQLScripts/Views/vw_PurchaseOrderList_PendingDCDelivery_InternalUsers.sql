...
IF EXISTS(SELECT * FROM sys.views WHERE NAME = 'vw_PurchaseOrderList_PendingDCDelivery_InternalUsers')
BEGIN
	 DROP VIEW vw_PurchaseOrderList_PendingDCDelivery_InternalUsers;
END
GO

CREATE VIEW [dbo].[vw_PurchaseOrderList_PendingDCDelivery_InternalUsers]
AS
	...
	ACT.ActivityDate
		...
		CROSS APPLY (
				...
				CROSS APPLY (
							...
							WHERE ACT.ActivityCode = '7002' AND CSMI.ShipmentId = SHI.Id AND ACT.[Location] = SHI.ShipTo
						)ACT
